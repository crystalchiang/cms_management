              ...
              <div class="col-sm-12 col-md-10 col-lg-8 col-xl-6">
                <div class="card">
                    <div class="card-header">
                      <div class="card-header"><h4>編輯班級</h4></div>
                    <div class="card-body">
                        ...
                        @endif
                        <br>
                        <form method="POST" action="/classInfo/{{ $class->id }}" id="app">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="form-group">
                                <label>班級名稱*</label>
                                <input class="form-control" type="text" placeholder="{{ __('班級名稱') }}" name="name" v-model="name" required>
                            </div>
                            ...
                            <div class="form-group">
                                <label>本期起始日</label>
                                <input class="form-control" type="date" value="{{ $class->period_start_date }}" placeholder="{{ __('本期起始日') }}" name="period_start_date">
                            </div>
                            ...
                            <div class="col-md-12 col-form-label row">
                              <div class="form-check form-check-inline mr-3">
                                <input class="form-check-input" type="checkbox" name="class_day[]" v-model="class_day" value="1">
                                <label class="form-check-label" for="inline-checkbox1">星期一</label>
                              </div>
                              <div class="form-check form-check-inline mr-3">
                                <input class="form-check-input" type="checkbox" name="class_day[]" v-model="class_day" value="2">
                                <label class="form-check-label" for="inline-checkbox2">星期二</label>
                              </div>
                              <div class="form-check form-check-inline mr-3">
                                <input class="form-check-input" type="checkbox" name="class_day[]" v-model="class_day" value="3">
                                <label class="form-check-label" for="inline-checkbox3">星期三</label>
                              </div>
                              <div class="form-check form-check-inline mr-3">
                                <input class="form-check-input" type="checkbox" name="class_day[]" v-model="class_day" value="4">
                                <label class="form-check-label" for="inline-checkbox4">星期四</label>
                              </div>
                              <div class="form-check form-check-inline mr-3">
                                <input class="form-check-input" type="checkbox" name="class_day[]" v-model="class_day" value="5">
                                <label class="form-check-label" for="inline-checkbox5">星期五</label>
                              </div>
                              <div class="form-check form-check-inline mr-3">
                                <input class="form-check-input" type="checkbox" name="class_day[]" v-model="class_day" value="6">
                                <label class="form-check-label" for="inline-checkbox6">星期六</label>
                              </div>
                              <div class="form-check form-check-inline mr-3">
                                <input class="form-check-input" type="checkbox" name="class_day[]" v-model="class_day" value="7">
                            ...
                            <div class="form-group">
                              <label>上課時段</label>
                              <select class="form-control" name="class_schedule" value="{{ $class->class_schedule }}" v-model="class_schedule" placeholder="請選擇">
...
<script>
  var app = new Vue({
    ...
    created() {
      ...
      this.branch_school_id = this.class.branch_school_id;
      this.teacher_id = this.class.teacher_id;
      this.assistant_id = this.class.assistant_id;
      this.supply_teacher_id = this.class.supply_teacher_id;
      this.teaching_material_1 = this.class.teaching_material_1;
      this.teaching_material_2 = this.class.teaching_material_2;
      this.teaching_material_3 = this.class.teaching_material_3;
      this.teaching_material_4 = this.class.teaching_material_4;
      this.class_day = this.class.class_day;
      this.class_schedule = this.class.class_schedule;
